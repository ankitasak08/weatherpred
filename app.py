...
def main():
    ...
    # Input fields
    temperature = st.number_input("Temperature (54°F-115°F)")
    humidity = st.number_input("Humidity (5-100%)")
    pressure = st.number_input("Pressure (27-29 hPa)")
    wind_chill = st.number_input("Wind Chill (53°F-113°F)")
    wind_speed = st.number_input("Wind Speed (0-5 m/s)")
